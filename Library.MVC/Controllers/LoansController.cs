...
namespace Library.MVC.Controllers
{
    public class LoansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,MemberId,LoanDate,DueDate,ReturnedDate")] Loan loan)
        {
            ...
            if (book == null || !book.IsAvailable || activeLoanExists)
            {
                ModelState.AddModelError("", "Ce livre n'est pas disponible pour un prêt.");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (loan.DueDate == default) loan.DueDate = DateTime.Today.AddDays(14);
